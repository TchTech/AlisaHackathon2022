    ...
    try:
        if text:
            ...
            ##Если пользователь уже был в навыке и вводил первую команду (грубо говоря, если пользователь очистил диалоговое окно с навыком)
                ...
                response_text = f"И снова здравствуй!\nЧтобы узнать пищевую ценность продукта на 100 грамм - вводи команду \"Расскажи про\" и название продукта (например: расскажи про чай). Хочешь поиграть в игру - вводи команду \"квест\". Узнать больше о моих возможностях ты можешь с помощью команды: \"Помощь\"."
                response_speak = f"И снова здравствуй!\nЧтобы узнать пищевую ценность продукта на 100 грамм - вводи команду \"Расскажи пр+о\" и название продукта (например: расскажи пр+о чай). Хочешь поиграть в игру - используй команду \"квест\". Узнать больше о моих возможностях ты можешь с помощью команды: \"Помощь\"."
                buttons = CalculateQuestMoreButtons
