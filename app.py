...
def main():
    ...
    text_correctly = req["request"]["command"].lower().strip().replace("!", "").replace("?", "") ##Текст такой, как его вводил пользователь
    ...
    try:
        if text:
            ...
            if ("расскажи" in text and "про" in text) or ("расскажи" in text and "что" in text and "находится" in text) or ("расскажи" in text and "о" in text) or ("расскажи" in text and "об" in text) or ("скажи" in text and "про" in text) or ("скажи" in text and "о" in text) or ("пожалуйста" in text and "про" in text) or ("что" in text or "как" in text and "насчёт" in text or "насчет" in text) or ("покажи" in text) or ("посчитай" in text and len(re.findall(r"\b\w*амм|\bг\w*|\bкг\w*", text)) <= 0): 
