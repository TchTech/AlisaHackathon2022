...
##Активирующие слова
ActivationWords = phrases_json["ActivationWords"] = ["расскажи про", "расскажи о", "расскажи об", "скажи про", "скажи о", "пожалуйста про", "посчитай", "рассчитай", "что насчет", "что насчёт", "как насчет", "как насчёт", "покажи", "скажи"]
...
def main():
    ...
    if text:
        ...
        if random_check == "случайный продукт" or random_check == "рандомный продукт"\
        ...
        if ("расскажи" in text and "про" in text) or ("расскажи" in text and "о" in text) or ("расскажи" in text and "об" in text) or ("скажи" in text and "про" in text) or ("скажи" in text and "о" in text) or ("пожалуйста" in text and "про" in text) or ("что" in text or "как" in text and "насчёт" in text) or ("посчитай" in text) or ("рассчитай" in text) or ("покажи" in text) or ("скажи" in text): 
        ...
        if text.split(" ")[0] in ["помощь"]:
            ...
            response_speak = "Я умею sil <[200]> первое. Считать пищевую ценность продукта при помощи команды \"Расскажи пр+о\". второе. Рассказывать о случайном продукте с помощью команды \"Расскажи про случайный продукт\". третье. Играть в мини-игру с помощью команды \"Квэст\"."
            buttons = QuestButton ##Пользователь уже в помощи, поэтому кнопки оставляем пустыми
            response_img = None
